...
class TypingIndicator extends StatefulWidget {
  const TypingIndicator({
    ...
    this.size = 1.0, // Added size parameter (default 1.0)
  });
...
class _TypingIndicatorState extends State<TypingIndicator>
  ...
  void initState() {
    ...
    _indicatorSpaceAnimation = CurvedAnimation(
      ...
      begin: 0.0,
      end: 60.0 * widget.size, // Adjusted for size
    ));
    ...
    return AnimatedBuilder(
      ...
      child: Stack(
        children: [
          ...
          //   left: 8 * widget.size,
          //   bottom: 8 * widget.size,
          //   bubble: _buildCircleBubble(8 * widget.size),
          // ),
          // _buildAnimatedBubble(
          //   animation: _mediumBubbleAnimation,
          //   left: 10 * widget.size,
          //   bottom: 10 * widget.size,
          //   bubble: _buildCircleBubble(16 * widget.size),
          // ),
          _buildAnimatedBubble(
            animation: _largeBubbleAnimation,
            left: 12 * widget.size,
            bottom: 12 * widget.size,
  ...
  Widget _buildStatusBubble() {
    return Container(
      width: 85 * widget.size,
      height: 44 * widget.size,
      padding: EdgeInsets.symmetric(horizontal: 8 * widget.size),
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(27 * widget.size),
        color: widget.bubbleColor,
        boxShadow: [
          BoxShadow(
